"""
Django settings for leg_site project.
...
WSGI_APPLICATION = "leg_site.wsgi.application"


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases

LOCAL_DB = "sqlite:///leg_site.db"
